...
import LocationSearch from "../../components/maps/suggestedPlaces";
import CombinedLocationSearch from "../../components/maps/suggestedPlaces";
const onChange = (e) => {
...
function Login({ stripePromise }) {
  ...
  const extraService = cart?.cartItems?.every(
    (item) =>
    ...
    (mapInstance) => {
      ...
      if (currentCenter) {
        mapInstance.fitBounds(
          new window.google.maps.LatLngBounds(currentCenter)
        );
  ...
  const autoComplete_Address = async (e) => {
    ...
    formdata.append("Text", "London NW10 7XH");
  ...
  const placeSearch = async (id) => {
    ...
    try {
      ...
      setselectedValue(
        FullAddress?.data?.Items?.map(
          (data) => data?.Text + " " + data?.Description
        )
      );
      console.log("inputValue2", ui);

      await GetLatLongonPostcode(
        FullAddress?.data?.Items?.map(
          (data) => data?.Description.split("London")[1]
        ).pop()
      );
    } catch (err) {
  ...
  const disabledDates = (current) => {
    ...
    return (
      current && (current < today || (current >= today && current <= maxDate))
    );
  };
  ...
  const createOrders = async (e) => {
    ...
    const {
      addressDetails: addressDetailss,
    ...
    const {
      ...
      collectNote: collectNotes,
      endDate: endDates,
      endTime: endTimes,
      delieverNote: delieverNotes,
      desc: descs,
    } = c;
    ...
    const dats = {
      ...
      Total: Math.round(
        useCode
          ? useCode
          : discount
          ? total.reduce((acc, data) => acc + data, 0) - discountAmount
          : total.reduce((acc, data) => acc + data, 0) + 1.99 + driverTip
      ),
    ...
    if (!checked.status) {
      ...
      if (totalAmount > checked?.data?.redeemCoupen?.discount) {
        let discount = Math.round(
          totalAmount - checked?.data?.redeemCoupen?.discount
        );
        SetuseCode(discount);
  ...
  useEffect(() => {
    if (input.length > 0) {
      const filteredSuggestions = selectedValue.filter((item) =>
  ...
  }, [input, selectedValue, addressDetails]);
  ...
  const handleSuggestionClick = (suggestion) => {
    setSuggestions([]);
    setaddressDetails(suggestion);
    setInput(suggestion); // You might want to clear suggestions here as well
  };
      ...
      content: (
        <>
          ...
          >
            ...
            >
              <Input
                ...
                className="web-input"
                // disabled={true}
                value={"London NW10 7XH"}
                // onChange={(e) => autoComplete_Address(e)}
                onFocus={(e) => autoComplete_Address(e)}
              />
              {/* <LocationSearch /> */}
              {/* <CombinedLocationSearch /> */}
              {recommendPostcode.length > 0 && inputValue !== "" ? (
                <div
                  style={{
                    height: "200px",
                    overflowY: "scroll",
              ...
              <>
                ...
                >
                  <List
                    ...
                    renderItem={(item) => (
                      <List.Item onClick={() => handlePostalCodeSelect(item)}>
                        {item}
                      </List.Item>
                    )}
                  />
            ...
            <div
              style={{ padding: selectedValue.length > 0 ? "20px" : "0px" }}
            ></div>
            {/* <Input
              size="large"
          ...
          <div>
            ...
            {!addressDetails ? null : !isGoogleMapLoaded ? (
              <>
                {(() => {
              ...
              isLoaded && (
                <GoogleMap
                  ...
                  center={
                    markers2.length ? markers2[0] : currentCenter || center
                  } // Center on marker or fallback to default
                  options={OPTIONS}
                  onLoad={onLoads}
                  onUnmount={onUnmount}
                >
              ...
              <>
                <div className="step-service-card">
                  <Row style={{ alignItems: "center", padding: "20px" }}>
                    ...
                    {data?._id === "6659994b3c1edcdfb89618b0" ? null : (
                      <>
                        <Col
                          lg={12}
                          md={12}
          ...
          >
            ...
            <Row gutter={[16, 16]} className="for-gutter-0">
              <Col lg={12} xs={24}>
                <Form.Item
                  label="Select day"
                  className="select-icon customDatePicker"
                >
                  {/* <Select
                    defaultValue="today"
                    style={{
            ...
            {startDate && bufferDays > 1 ? (
              <Row style={{ justifyContent: "space-between" }}>
                ...
                <div>
                  <span className="f-16" style={{ marginRight: "10px" }}>
            ...
            >
              ...
              <Col lg={12} xs={24}>
                ...
                >
                  <TimePicker
                    className="web-select23"
                    onChange={(time, timeString) => handleChangeEnd(timeString)}
                    defaultOpenValue={dayjs("00:00:00", "HH:mm:ss")}
                  />
                </Form.Item>
              </Col>
              ...
              <Col lg={12} xs={24}>
                ...
                >
                  <Input
                    ...
                    className="web-input"
                    onChange={(e) =>
                      handleContactDetails("firstName", e.target.value)
                    }
              ...
              <Col lg={12} xs={24}>
                ...
                >
                  <Input
                    ...
                    className="web-input"
                    onChange={(e) =>
                      handleContactDetails("lastName", e.target.value)
                    }
              ...
              <Col lg={12} xs={24}>
                ...
                >
                  <Input
                    ...
                    className="web-input"
                    onChange={(e) =>
                      handleContactDetails("phoneNumber", e.target.value)
                    }
              ...
              <Col lg={12} xs={24}>
                ...
                >
                  <Input
                    ...
                    className="web-input"
                    onChange={(e) =>
                      handleContactDetails("email", e.target.value)
                    }
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <div>{/* <CardElement className={cardStyle} /> */}</div>
        </>
      ),
    },
  ];
            ...
            <Col lg={8}>
              ...
              >
                ...
                {!error && !carterror && !totalError && !nexterror ? (
                  ...
                  <p
                    className="mainbtn"
                    style={{ fontSize: 15, borderBlock: 10, marginBottom: 20 }}
                  >
                    {error
                      ? error
                      : carterror
                ...
                {current === steps.length - 1 && (
                  <Button className="web-btn" onClick={(e) => createOrders(e)}>
                    PLACE ORDER
                  </Button>
                )}
                  ...
                  <Row>
                    ...
                    >
                      <p className="">
                        ...
                        {useCode
                          ? useCode
                          : total?.reduce((acc, data) => acc + data, 0)}
                      </p>
                    </Col>
                    <Col lg={14} md={14} sm={14} xs={24}>
                                ...
                                <>
                                  ...
                                  <div>
                                    ...
                                    <p className="f-14">
                                      ...
                                      {data.startTime} {data.collectNote}
                                    </p>
                                  </div>
                                </>
                              );
                                ...
                                <>
                                  ...
                                  <div>
                                    ...
                                    <p className="f-14">
                                      ...
                                      {data.endTime} {data.delieverNote}
                                    </p>
                                  </div>
                                </>
                              );
                                ...
                                <>
                                  <p className="f-14">
                                    <Image
                                      preview={false}
                                      src={
                                        ImageURLS + data.categoryData.catImage
                                      }
                                      alt="paymentcards"
                                      className="selected-service-img"
                                    />
                                    <strong>{data.title}</strong> Price per
                                    weight
                                  </p>
                                </>
                              );
